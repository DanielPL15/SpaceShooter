...
import com.danielpl.spaceshootersample.util.Config.OVAL_RANDOMIZER_MIN
import com.danielpl.spaceshootersample.util.Config.RAD_MIN
...
class Star : Entity() {
    ...
    private val radius: Float = (Config.RNG.nextInt(RAD_MIN) + 2).toFloat()
    private lateinit var shape: String
    private val rx: Float = (Config.RNG.nextInt(RAD_MIN) + 2).toFloat()
    private val ry: Float = (Config.RNG.nextInt(RAD_MIN) + 2).toFloat()
    private val ovalRandomizer = (Config.RNG.nextFloat() + OVAL_RANDOMIZER_MIN)
